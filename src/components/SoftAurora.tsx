...
export default function SoftAurora({
    ...
    useEffect(() => {
        ...
        // Listen on window for global mouse movement tracking (handles pointer-events-none perfectly)
        ...
        return () => {
            ...
            try {
                ...
                // Safe check if standard WebGL parent has unmounted
            }
    ...
    return (
        <div className="absolute inset-0 overflow-hidden bg-transparent z-0 pointer-events-none">
            {/* Dynamic OGL WebGL element insertion canvas container */}
            <div ref={containerRef} className="absolute inset-0 w-full h-full mix-blend-screen opacity-95" />

            {/* Subtle modern noise/grid details */}
